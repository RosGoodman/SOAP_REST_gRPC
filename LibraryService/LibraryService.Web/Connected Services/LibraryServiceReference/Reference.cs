...
namespace LibraryServiceReference
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="BookModel", Namespace="http://tempuri.org/")]
    public partial class BookModel : object
    {
        ...
        private LibraryServiceReference.AuthorModel[] AuthorsField;
        ...
        public LibraryServiceReference.AuthorModel[] Authors
        {
            get
            {
    ...
    public partial class AuthorModel : object
    {
    ...
    public partial class GetBooksByTitleResponseBody
    {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public LibraryServiceReference.BookModel[] GetBooksByTitleResult;
        
        public GetBooksByTitleResponseBody()
        {
        }
        
        public GetBooksByTitleResponseBody(LibraryServiceReference.BookModel[] GetBooksByTitleResult)
        {
    ...
    public partial class GetBooksByAuthorResponseBody
    {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public LibraryServiceReference.BookModel[] GetBooksByAuthorResult;
        
        public GetBooksByAuthorResponseBody()
        {
        }
        
        public GetBooksByAuthorResponseBody(LibraryServiceReference.BookModel[] GetBooksByAuthorResult)
        {
    ...
    public partial class GetBooksByCategoryResponseBody
    {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public LibraryServiceReference.BookModel[] GetBooksByCategoryResult;
        
        public GetBooksByCategoryResponseBody()
        {
        }
        
        public GetBooksByCategoryResponseBody(LibraryServiceReference.BookModel[] GetBooksByCategoryResult)
        {
    ...
    public partial class LibraryWebServiceSoapClient : System.ServiceModel.ClientBase<LibraryServiceReference.LibraryWebServiceSoap>, LibraryServiceReference.LibraryWebServiceSoap
    {
        ...
        public LibraryServiceReference.BookModel[] GetBooksByTitle(string title)
        {
        ...
        public LibraryServiceReference.BookModel[] GetBooksByAuthor(string author)
        {
        ...
        public LibraryServiceReference.BookModel[] GetBooksByCategory(string category)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.LibraryWebServiceSoap))
            {
                return new System.ServiceModel.EndpointAddress("https://localhost:44375/LibraryWebService.asmx");
            }
            if ((endpointConfiguration == EndpointConfiguration.LibraryWebServiceSoap12))
            {
                return new System.ServiceModel.EndpointAddress("https://localhost:44375/LibraryWebService.asmx");
